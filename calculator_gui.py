...
add curly braces as parans but they cant go like this {3+3) eh should i tho?

also i need to work on order of operatoins somethings arent completely right like it doesnt serach for thefirst function occurence it serachse for factorial then sin etc
...
class Window(Frame):
    ...
    def create_widgets(self, *refresh_inp):
        ...
        if self.is_second:
            ...
            factorial = Button(self.master, text='  1/x  ', bg = 'gray',fg='white', command=lambda: self.button_command('1/', 0))
